if(next_upgrade_affordable)
{
	...
	switch(sword_tier)
	{
		case sword_tiers.WOOD:
			player_stats.mouse_damage = sword_tier_damage.WOOD/10;
		...
		case sword_tiers.IRON:
			player_stats.mouse_damage = sword_tier_damage.IRON/10;
		...
		case sword_tiers.GOLD:
			player_stats.mouse_damage = sword_tier_damage.GOLD/10;
		...
		case sword_tiers.BLOOD:
			player_stats.mouse_damage = sword_tier_damage.BLOOD/10;
			fully_upgraded = true;
			break;
